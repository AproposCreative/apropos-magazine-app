//
//  SelectButtonTitleSubtitleBadgeView.swift
//  Native
//

import SwiftUI

struct SelectButtonTitleSubtitleBadgeView: View {
...
private extension SelectButtonTitleSubtitleBadgeView {
...
private extension SelectButtonTitleSubtitleBadgeView {
    ...
    @ViewBuilder
    private var horizontalLabelItem: some View {
        selectButton
        titleSubtitle
        badge
    }
    ...
    @ViewBuilder
    private var verticalLabelItem: some View {
        verticalHeader
        titleSubtitle
    }
