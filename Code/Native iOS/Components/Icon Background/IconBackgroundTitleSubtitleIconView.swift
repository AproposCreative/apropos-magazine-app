//
//  IconBackgroundTitleSubtitleIconView.swift
//  Native
//

import SwiftUI

struct IconBackgroundTitleSubtitleIconView: View {
    ...
    /// Alignment of the title, subtitle, and the second icon:
    private let titleSubtitleSecondIconAlignment: VerticalAlignment
    
    /// Spacing between the title, subtitle, and the second icon:
    private let titleSubtitleSecondIconSpacing: Double
    ...
    init(
        ...
        titleSubtitleSecondIconAlignment: VerticalAlignment = .top,
        titleSubtitleSecondIconSpacing: Double = 4,
        ...
        self.titleSubtitleSecondIconAlignment = titleSubtitleSecondIconAlignment
        self.titleSubtitleSecondIconSpacing = titleSubtitleSecondIconSpacing
...
private extension IconBackgroundTitleSubtitleIconView {
    @ViewBuilder
    ...
    private var verticalItemHeader: some View {
        HStack(
            alignment: titleSubtitleSecondIconAlignment,
            spacing: titleSubtitleSecondIconSpacing
        ) {
...
// MARK: - Title, subtitle, and second icon:

private extension IconBackgroundTitleSubtitleIconView {
    private var titleSubtitleSecondIcon: some View {
        HStack(
            alignment: titleSubtitleSecondIconAlignment,
            spacing: titleSubtitleSecondIconSpacing
        ) {
            titleSubtitleSecondIconContent
        }
    }
    
    @ViewBuilder
    private var titleSubtitleSecondIconContent: some View {
        titleSubtitle
        secondIconContent
    }
}
...
#Preview {
    ScrollView {
        IconBackgroundTitleSubtitleIconView(
            ...
            titleSubtitleSecondIconSpacing: 4,
