//
//  IconBackgroundTitleSubtitleProgressView.swift
//  Native
//

import SwiftUI

struct IconBackgroundTitleSubtitleProgressView: View {
...
private extension IconBackgroundTitleSubtitleProgressView {
    @ViewBuilder
