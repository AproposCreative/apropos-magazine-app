//
//  IconBackgroundTitleSubtitleValueIconView.swift
//  Native
//

import SwiftUI

struct IconBackgroundTitleSubtitleValueIconView: View {
    ...
    /// Alignment of the title, value, subtitle, and the second icon:
    private let titleValueSubtitleSecondIconAlignment: VerticalAlignment
    
    /// Spacing between the title, value, subtitle, and the second icon:
    private let titleValueSubtitleSecondIconSpacing: Double
    ...
    init(
        ...
        titleValueSubtitleSecondIconAlignment: VerticalAlignment = .top,
        titleValueSubtitleSecondIconSpacing: Double = 4,
        ...
        self.titleValueSubtitleSecondIconAlignment = titleValueSubtitleSecondIconAlignment
        self.titleValueSubtitleSecondIconSpacing = titleValueSubtitleSecondIconSpacing
...
private extension IconBackgroundTitleSubtitleValueIconView {
    @ViewBuilder
    ...
    private var verticalItemHeaderValueSecondIconContent: some View {
        HStack(
            alignment: titleValueSubtitleSecondIconAlignment,
            spacing: titleValueSubtitleSecondIconSpacing
        ) {
...
// MARK: - Title, value, subtitle, and second icon:

private extension IconBackgroundTitleSubtitleValueIconView {
    private var titleValueSubtitleSecondIcon: some View {
        HStack(
            alignment: titleValueSubtitleSecondIconAlignment,
            spacing: titleValueSubtitleSecondIconSpacing
        ) {
            titleValueSubtitleSecondIconContent
        }
    }
    
    @ViewBuilder
    private var titleValueSubtitleSecondIconContent: some View {
        titleValueSubtitle
        secondIconContent
    }
}
...
#Preview {
    ScrollView {
        IconBackgroundTitleSubtitleValueIconView(
            ...
            secondIconFrame: 22,
            titleValueSubtitleSecondIconAlignment: .top,
            titleValueSubtitleSecondIconSpacing: 4,
