//
//  ImageBackgroundTitleSubtitleIconView.swift
//  Native
//

import SwiftUI

struct ImageBackgroundTitleSubtitleIconView: View {
    ...
    /// Alignment of the title, subtitle, and the icon:
    private let titleSubtitleIconAlignment: VerticalAlignment
    
    /// Spacing between the title, subtitle, and the icon:
    private let titleSubtitleIconSpacing: Double
    ...
    init(
        ...
        isShowingImageBackground: Bool = true,
        ...
        titleSubtitleIconAlignment: VerticalAlignment = .center,
        titleSubtitleIconSpacing: Double = 4,
        ...
        self.titleSubtitleIconAlignment = titleSubtitleIconAlignment
        self.titleSubtitleIconSpacing = titleSubtitleIconSpacing
...
private extension ImageBackgroundTitleSubtitleIconView {
    @ViewBuilder
    ...
    private var verticalItemHeader: some View {
        HStack(
            alignment: titleSubtitleIconAlignment,
            spacing: titleSubtitleIconSpacing
        ) {
...
// MARK: - Title, subtitle, and icon:

private extension ImageBackgroundTitleSubtitleIconView {
    private var titleSubtitleIcon: some View {
        HStack(
            alignment: titleSubtitleIconAlignment,
            spacing: titleSubtitleIconSpacing
        ) {
            titleSubtitleIconContent
        }
    }
    
    @ViewBuilder
    private var titleSubtitleIconContent: some View {
        titleSubtitle
        iconContent
    }
}
...
#Preview {
    ScrollView {
        ImageBackgroundTitleSubtitleIconView(
            ...
            iconFrame: 22,
            titleSubtitleIconAlignment: .center,
            titleSubtitleIconSpacing: 4,
