//
//  ImageBackgroundTitleSubtitleView.swift
//  Native
//

import SwiftUI

struct ImageBackgroundTitleSubtitleView: View {
    ...
    init(
        ...
        titleSubtitleMaxWidthAlignment: Alignment = .center,
...
private extension ImageBackgroundTitleSubtitleView {
    @ViewBuilder
