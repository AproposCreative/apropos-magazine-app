//
//  ImageBackgroundTitleSubtitleProgressView.swift
//  Native
//

import SwiftUI

struct ImageBackgroundTitleSubtitleProgressView: View {
    ...
    /// Content of the alignment of the view that is based on the size of the dynamic type that is currently selected:
...
private extension ImageBackgroundTitleSubtitleProgressView {
    @ViewBuilder
