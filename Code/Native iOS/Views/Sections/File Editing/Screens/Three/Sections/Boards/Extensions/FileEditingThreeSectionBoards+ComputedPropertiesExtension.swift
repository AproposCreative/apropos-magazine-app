//
//  FileEditingThreeSectionBoards+ComputedPropertiesExtension.swift
//  Native
//
...
extension FileEditingThreeSectionBoardsView {
    ...
    /// 'Bool' value indicating whether or not an array of the boards to display is empty:
    var isEmpty: Bool {
        boards.isEmpty
    }
    
    /// An array of the boards that are part of the section to display:
    var boards: [NT_WhiteboardBoard] {
        section.boards
    }
    
    /// An array of the columns to display the boards in the grid:
