//
//  OnboardingTwelve+FunctionsExtension.swift
//  Native
//
...
extension OnboardingTwelveView {
    ...
    func image(_ feature: NT_Feature) -> Image {
        .init(feature.onboarding12Image)
    }
    ...
    func getStarted() {
        ...
        case .reusableComponents:
            ...
            /// If it's the third one, then simply dismissing the view because there are no other features displayed:
            dismiss()
        case .globalStyleguide,
                .fullyAccessible,
                .scalableSourceCode:
            
            /// If it's either the fourth, the fifth, or the sixth one, then simply breaking because they simply aren't displayed here:
            break
        case .none:
