//
//  PaywallThreeView.swift
//  Native
//

import SwiftUI

struct PaywallThreeView: View {
...
private extension PaywallThreeView {
...
private extension PaywallThreeView {
    ...
    private var scrollItemContent: some View {
        featuresPaginationPlans
        PaywallLegalView()
    }
}

// MARK: - Features, pagination, and plans:

private extension PaywallThreeView {
    private var featuresPaginationPlans: some View {
        VStack(
            alignment: .center,
            spacing: 48
        ) {
            featuresPaginationPlansContent
        }
    }
    
    @ViewBuilder
    private var featuresPaginationPlansContent: some View {
