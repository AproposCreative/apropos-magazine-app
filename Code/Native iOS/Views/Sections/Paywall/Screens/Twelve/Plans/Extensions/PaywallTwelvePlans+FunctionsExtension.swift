//
//  PaywallTwelvePlans+FunctionsExtension.swift
//  Native
//

import Foundation

extension PaywallTwelvePlansView {
    ...
    func select(_ plan: NT_ProPlan) {
        ...
        if !isSelected(plan) {
            ...
            /// Then adding a delay of a quarter of a second before dismissing the view:
            DispatchQueue.main.asyncAfter(deadline: .now() + 0.25) {
                
                /// Lastly dismissing the view:
                dismiss()
            }
        }
    }
