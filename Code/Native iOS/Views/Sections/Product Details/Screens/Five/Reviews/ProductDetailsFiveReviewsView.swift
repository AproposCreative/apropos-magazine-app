//
//  ProductDetailsFiveReviewsView.swift
//  Native
//

import SwiftUI

struct ProductDetailsFiveReviewsView: View {
...
private extension ProductDetailsFiveReviewsView {
...
#Preview {
    ScrollView {
        ProductDetailsFiveReviewsView(product: .example.first!)
    }
    .safeAreaPadding(
        .all,
        16
