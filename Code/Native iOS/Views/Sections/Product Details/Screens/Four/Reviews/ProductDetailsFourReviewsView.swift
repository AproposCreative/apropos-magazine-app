//
//  ProductDetailsFourReviewsView.swift
//  Native
//

import SwiftUI

struct ProductDetailsFourReviewsView: View {
...
private extension ProductDetailsFourReviewsView {
...
#Preview {
    ScrollView {
        ProductDetailsFourReviewsView(product: .example.first!)
    }
    .safeAreaPadding(
        .all,
        16
