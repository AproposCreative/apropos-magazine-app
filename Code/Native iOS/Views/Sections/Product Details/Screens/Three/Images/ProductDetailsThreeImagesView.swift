//
//  ProductDetailsThreeImagesView.swift
//  Native
//

import SwiftUI

struct ProductDetailsThreeImagesView: View {
...
private extension ProductDetailsThreeImagesView {
...
#Preview {
    ScrollView {
        ProductDetailsThreeImagesView(product: .example.first!)
    }
    .safeAreaPadding(
        .all,
        16
