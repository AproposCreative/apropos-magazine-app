//
//  ProductDetailsTwoDetailsView.swift
//  Native
//

import SwiftUI

struct ProductDetailsTwoDetailsView: View {
...
private extension ProductDetailsTwoDetailsView {
    @ViewBuilder
...
#Preview {
    ScrollView {
        ProductDetailsTwoDetailsView(product: .example.first!)
    }
    .safeAreaPadding(
        .all,
        16
