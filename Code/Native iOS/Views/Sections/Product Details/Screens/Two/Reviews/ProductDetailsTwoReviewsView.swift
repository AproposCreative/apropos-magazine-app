//
//  ProductDetailsTwoReviewsView.swift
//  Native
//

import SwiftUI

struct ProductDetailsTwoReviewsView: View {
...
private extension ProductDetailsTwoReviewsView {
...
#Preview {
    ScrollView {
        ProductDetailsTwoReviewsView(product: .example.first!)
    }
    .safeAreaPadding(
        .all,
        16
