//
//  ProfileFiveOverview+ComputedPropertiesExtension.swift
//  Native
//
...
extension ProfileFiveOverviewView {
    ...
    var overviewItems: [NT_ProfileAuthorOverview] {
        author.overviewItem
    }
    
    /// An array of the columns to display the overview items in the grid:
