//
//  SignUpFourView.swift
//  Native
//

import SwiftUI

struct SignUpFourView: View {
    ...
    /// First line of the address that is inputed by the user:
    @State var firstLine: String = ""
    
    /// Second line of the address that is inputed by the user:
    @State var secondLine: String = ""
    
    /// City that is inputed by the user:
    @State var city: String = ""
    
    /// State that is inputed by the user:
...
private extension SignUpFourView {
...
private extension SignUpFourView {
    ...
    @ViewBuilder
    private var accountDetailsItem: some View {
...
private extension SignUpFourView {
    ...
    private var firstLineTextField: some View {
        TextFieldView(
            text: $firstLine,
            title: "First Line",
            verticalPadding: 0,
    ...
    private var secondLineTextField: some View {
        TextFieldView(
            text: $secondLine,
            title: "Second Line",
            verticalPadding: 0,
    ...
    private var stateTextField: some View {
        TextFieldView(
            text: $state,
            title: "State",
            verticalPadding: 0,
