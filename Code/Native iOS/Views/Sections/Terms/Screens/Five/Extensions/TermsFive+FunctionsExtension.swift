//
//  TermsFive+FunctionsExtension.swift
//  Native
//
...
extension TermsFiveView {
    ...
    func fetchData() async {
        ...
        await MainActor.run {
            ...
            /// Then getting an array of the overview items for the terms that are based on an array of the example overview items:
            let overviewItems: [NT_TermsOverview] = NT_TermsOverview.example
            
            /// Then assigning an array of the overview items for the terms to display:
            self.overviewItems = overviewItems
            
            /// Then also getting an array of the sections with the terms that are based on an array of the example sections:
    ...
    /// Lets the user download the terms as a PDF file:
    func downloadPDF() {
        
        /*
         
         NOTE: You can add your own logic for downloading the PDF file here.
